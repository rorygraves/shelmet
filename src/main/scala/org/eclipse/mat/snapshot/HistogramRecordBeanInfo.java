...
public class HistogramRecordBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            final PropertyDescriptor propertyDescriptor1 = new PropertyDescriptor("label", HistogramRecord.class) {
                public String getDisplayName() {
                    return Messages.HistogramRecordBeanInfo_Label;
                }
            };
            final PropertyDescriptor propertyDescriptor2 = new PropertyDescriptor("numberOfObjects", HistogramRecord.class) {
                public String getDisplayName() {
                    return Messages.HistogramRecordBeanInfo_NumberOfObjects;
                }
            };
            final PropertyDescriptor propertyDescriptor3 = new PropertyDescriptor("usedHeapSize", HistogramRecord.class) {
                public String getDisplayName() {
                    return Messages.HistogramRecordBeanInfo_UsedHeapSize;
                }
            };
            final PropertyDescriptor propertyDescriptor4 = new PropertyDescriptor("retainedHeapSize", HistogramRecord.class) {
                public String getDisplayName() {
