...
public final class PieFactory {
     ...
     *
     * @param snapshot snapshot containing the objects
     * @param pieSize  total size of the pie
     */
     ...
     *
     * @param objectId object id
     * @param color    Explicit color of the slice
     * @return a new slice
     * @since 1.2
     */
     ...
     *
     * @param objectId         object id
     * @param label            (optionally) a label describing the object (for display)
     * @param usedHeapSize     (optionally) the used heap size (for display)
     * @param retainedHeapSize the retained size which determines the size of the slice
     * @return a new slice
     */
     ...
     * @param usedHeapSize     (optionally) the used heap size (for display)
     * @param retainedHeapSize the retained size which determines the size of the slice
     * @param color            the color to use for the slice
     * @return a new slice
     * @since 1.2
     */
    ...
    private final static class SliceImpl implements IResultPie.ColoredSlice, Serializable {
        ...
        public String getDescription() {
            ...
            if (label != null) {
                buf.append(HTML_BREAK).append("<p>").append(Messages.PieFactory_Label_ShallowSize).append(" <b>");
