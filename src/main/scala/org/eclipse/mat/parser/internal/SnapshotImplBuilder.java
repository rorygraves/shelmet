...
public class SnapshotImplBuilder {
    ...
    public SnapshotImpl create(IProgressListener listener) throws IOException, SnapshotException {
        IObjectReader heapObjectReader = new HprofHeapObjectReader();

        // TODO - check uniqueID
        return SnapshotImpl.create(snapshotInfo, "uniqueID", heapObjectReader, classCache, roots,
