...
public class HeapDumpInfoQuery implements IQuery {
    ...
    public static class TextEntryBeanInfo extends SimpleBeanInfo {
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
            ...
            try {
                final PropertyDescriptor propertyDescriptor1 = new PropertyDescriptor("propertyName", TextEntry.class, "getPropertyName", null) {
                    public String getDisplayName() {
                        return Messages.HeapDumpInfoQuery_PropertyName;
                    }
                };
                final PropertyDescriptor propertyDescriptor2 = new PropertyDescriptor("propertyValue", TextEntry.class, "getPropertyValue", null) {
                    public String getDisplayName() {
    ...
    public IResult execute(IProgressListener listener) throws Exception {
        ...
        Serializable identifier = info.getProperty("$runtimeId");
