...
public class FindLeaksQuery implements IQuery {
    ...
    private int[] getRandomIds(int[] objectIds) {
        ...
        System.out.println("LOG: INFO" + MessageUtil.format(
    ...
    public static class SuspectsResultTable implements IResultTable {
        ...
        public Object getColumnValue(Object row, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                case 3:
                    return (double) suspect.suspectRetained / (double) totalHeap;
                case 4:
                ...
                case 5:
                    return suspect.accumulationPoint == null ? 0 : suspect.accumulationPoint.getObject()
                            .getRetainedHeapSize();
                case 6:
                    return suspect.accumulationPoint == null ? 0 : (double) suspect.accumulationPoint
