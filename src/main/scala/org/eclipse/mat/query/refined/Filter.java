            ...
            try {
                ...
                if (indexOfDots >= 0) {
                    ...
                    if (lowerBound != null && upperBound != null)
                        newTest = new CompositeTest(new LowerEqualBoundary(lowerBound),
                                new UpperEqualBoundary(upperBound));
                    ...
                    if (criteria.charAt(0) == '>') {
                        if (criteria.charAt(1) == '=')
                            newTest = new LowerEqualBoundary(number(criteria.substring(2)));
                        else
                            newTest = new LowerBoundary(number(criteria.substring(1)));
                    } else if (criteria.charAt(0) == '<')
                        if (criteria.charAt(1) == '=')
                            newTest = new UpperEqualBoundary(number(criteria.substring(2)));
                        else
                            newTest = new UpperBoundary(number(criteria.substring(1)));
                    else
                        newTest = new EqualsTest(number(criteria));
                }
